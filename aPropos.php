...
<main class="a-propos">
    ...
    <div class="content-container">
        <div class="apropos-col-container">
            ...
            <div class="onglet-info">
                ...
                <div class="cv-container">
                    <img src="./img/CV.png" alt="Image CV" />
                    <p><strong>Télécharger mon CV :</strong> <a href="./img/CV.png" title="Télécharger mon CV" download="CV_ALLIONE_Florian.png">Cliquez ici</a></p>
                </div>
            </div>
        </div>
        <div class="onglet-info">
            ...
            <hr class="under-title" />
            <p>Vous pourrez découvrir en cliquant sur ce lien, mon profil Linkedin qui regroupe un peu tout ce que j'ai fait jusqu'à aujourd'hui : <a href="https://www.linkedin.com/in/florian-allione-40879817a/" title="Vers ma page Linkedin" target="_blank">Ma page Linkedin</a></p>
        </div>
    </div>
</main>
